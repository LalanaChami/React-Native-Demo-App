 ...
 * limitations under the License.
 */
/** The semver (www.semver.org) version of the SDK. */ var w$1 = i.SDK_VERSION, b = new Logger("@firebase/firestore");
...
function(t, e, n, r, i) {
    ...
    return Object.defineProperty(t.prototype, "i", {
        ...
        return U$1(this.projectId, t.projectId) || U$1(this.database, t.database);
    }, t;
}();
 ...
 */ var C$1 = /** @class */ function() {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new x$1(q$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new x$1(q$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new x$1(q$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new x$1(q$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    n.N = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
}(G$1), z = /^[_a-zA-Z][_a-zA-Z0-9]*$/, Q$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.V = function(t, e, r) {
    ...
    n.q = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new x$1(q$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new x$1(q$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new x$1(q$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.k = function() {
        return new n([]);
    }, n;
}(G$1), W$1 = /** @class */ function() {
    function t(t) {
        this.path = t;
    }
    return t.B = function(e) {
        return new t(B$1.N(e).p(5));
    }, 
    /** Returns true if the document is in the specified collectionId. */ t.prototype.U = function(t) {
        return this.path.length >= 2 && this.path.get(this.path.length - 2) === t;
    }, t.prototype.isEqual = function(t) {
        return null !== t && 0 === B$1.P(this.path, t.path);
    }, t.prototype.toString = function() {
        return this.path.toString();
    }, t.P = function(t, e) {
        return B$1.P(t.path, e.path);
    }, t.W = function(t) {
        return t.length % 2 == 0;
    }, 
    /**
 ...
 */
// Visible for testing
var Y$1 = function(t, e, n, r, i, o, s) {
...
var et, nt, rt = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = F$1.min()), void 0 === o && (o = F$1.min()), void 0 === s && (s = tt.Y), 
 ...
 */ function st(t) {
    ...
    return N$1("GRPC error has no .code"), q$1.UNKNOWN;
    switch (t) {
      case et.OK:
        return q$1.OK;
...
var gt = new ut(W$1.P), mt = new ct(W$1.P);
 ...
 */ var It = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, _t.zt(e, n)), new t(F$1.min(), r, Et(), pt(), wt());
    }, t;
}(), _t = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.$e = function(t) {
        ...
        return this.Ie = pt(), this.Ae = St(), this.Re = new ct(U$1), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.me.get(t);
        return e || (e = new Ut, this.me.set(t, e)), e;
    }, t.prototype.ke = function(t) {
        var e = this.Ae.get(t);
        return e || (e = new ct(U$1), this.Ae = this.Ae.nt(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Se = function(t) {
        var e = this;
        this.me.set(t, new Ut), this.Ee.xe(t).forEach((function(n) {
...
/** Extracts the backend's type order for the provided value. */ function Ct(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Rt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : T$1();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function qt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return k$1(t.arrayValue.values || [], e.arrayValue.values || [], qt);
    ...
    switch (n) {
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return U$1(n.length, r.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = U$1(zt(t.latitude), zt(e.latitude));
            return 0 !== n ? n : U$1(zt(t.longitude), zt(e.longitude));
...
function Ft(t, e) {
    ...
    var n = Bt(t), r = Bt(e), i = U$1(n.seconds, r.seconds);
    return 0 !== i ? i : U$1(n.nanos, r.nanos);
}
...
function Gt(t) {
    return function t(e) {
        ...
        W$1.B(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function ae(t, e) {
    return function(t) {
        return new B$1([ "projects", t.projectId, "databases", t.database ]);
...
function le(t) {
    return new B$1([ "projects", t.s.projectId, "databases", t.s.database ]).$();
}
 ...
 */ function Ae(t, e) {
    return t instanceof Ue ? Ht(n = e) || function(t) {
 ...
 */ function je(t, e, n, r) {
    return t instanceof ze ? function(t, e) {
        ...
        return Ce(t.Ue, e) ? new rn(t.key, F$1.min()) : e;
    }(t, e);
}
...
function Ge(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Ue.isEqual(e.Ue) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.Me.isEqual(e.Me) : 2 /* Transform */ !== t.type || k$1(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof _e && e instanceof _e || t instanceof Pe && e instanceof Pe ? k$1(t.elements, e.elements, qt) : t instanceof Ue && e instanceof Ue ? qt(t.qe, e.qe) : t instanceof Te && e instanceof Te;
 ...
 */ function Be(t) {
    return t instanceof nn ? t.version : F$1.min();
}
...
var en = function(t, e) {
    ...
    return t.on = function(e) {
        ...
        get: function() {
            if (null === this.nn) {
                ...
                t.L() || this.nn.push(new In(t)), this.nn.push(new In(Q$1.M(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.Tn = function() {
        ...
        return !H$1(this.limit) && "F" /* First */ === this.en;
    }, t.prototype.mn = function() {
        return !H$1(this.limit) && "L" /* Last */ === this.en;
    ...
    t.prototype.Pn = function() {
        if (!this.sn) if ("F" /* First */ === this.en) this.sn = X$1(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            for (
            ...
            // Now return as a LimitType.First query.
                        this.sn = X$1(this.path, this.collectionGroup, t, this.filters, this.limit, o, s);
        }
        return this.sn;
...
/** Returns whether `doc` matches the constraints of `query`. */ function cn(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.U(t.collectionGroup) && t.path.C(n) : W$1.W(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
...
var ln = /** @class */ function(e) {
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        ...
        if (Yt(r)) {
            if ("==" /* EQUAL */ !== e) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (Xt(r)) {
            if ("==" /* EQUAL */ !== e) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
...
var pn = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = W$1.B(r.referenceValue), i;
    }
 ...
 */ function bn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.L() ? W$1.P(W$1.B(s.referenceValue), n.key) : jt(s, n.field(o.field)), 
...
function Nn(t, e, n) {
    var r = t.field.L() ? W$1.P(e.key, n.key) : function(t, e, n) {
        var r = e.field(t), i = n.field(t);
        return null !== r && null !== i ? jt(r, i) : T$1();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var Tn = /** @class */ function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.kn && T$1(), this.kn = !0, this.Nn ? this.error ? this.xn(n, this.error) : this.On(e, this.result) : new t((function(t, i) {
            r.Fn = function(n) {
                r.On(e, n).next(t, i);
            }, r.$n = function(e) {
                r.xn(n, e).next(t, i);
    ...
    t.prototype.Xn = function(t, e) {
        ...
        return this.Qn.Jn(t, e).next((function(r) {
            ...
            return i.forEach((function(t, e) {
                ...
                e || (e = new rn(t, F$1.min())), o = o.nt(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.Zn = function(t, e, n) {
        ...
        return this.jn(t, new W$1(e)).next((function(t) {
            var e = vt();
...
/** The result of applying a mutation batch to the backend. */ Un.ds = -1;
...
var kn = function() {
    ...
    t.prototype.ys = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && I$1("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.As + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.S(), n = t.g(), r = this.index[e] || new ct(B$1.P), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.S(), n = t.g(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new ct(B$1.P)).F();
    }, t;
}(), On = /** @class */ function() {
    function t(t) {
        this.Ds = t;
 ...
 */ var qn = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Ns = t, this.Ts = e, this.ks = n, this.op = r, this.xs = i, this.Os = new kn, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.Ms && (this.clearTimeout(), this.Os.reject(new x$1(q$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    t.prototype.ii = function() {
        ...
        var e = this, n = this.Us.then((function() {
            return e.Ks = !0, t().catch((function(t) {
                ...
                throw e.Gs = t, e.Ks = !1, N$1("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
function jn(t, e) {
    if (N$1("AsyncQueue", e + ": " + t), Mn(t)) return new x$1(q$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var Gn = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.pi = F$1.min(), this.Qn = t.gi(n), this.vi = t.bi(), this.Si = t.Ci(), this.Di = new Pn(this.vi, this.Qn, this.persistence.Fi()), 
        this.Pi.$i(this.Di);
    }
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.jt.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof rn && h.version.isEqual(F$1.min()) ? (
                    ...
                    a = a.nt(i, h)) : I$1("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", c.version, " Watch version:", h.version), 
    ...
    t.nr = function(t, e, n) {
        ...
        var n = this, r = this.Vi.get(t), i = e ? "readwrite" : "readwrite-primary";
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? Dn.resolve() : n.persistence.hr.removeTarget(t, r);
        })).then((function() {
            n.Vi = n.Vi.remove(t), n.yi.delete(r.target);
        }));
    }, t.prototype.Pr = function(t, e) {
        var n = this, r = F$1.min(), i = wt();
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.mr(o, t.Pn()).next((function(t) {
                ...
                return n.Pi.Zn(o, t, e ? r : F$1.min(), e ? i : wt());
            })).next((function(t) {
                return {
                    documents: t,
                    yr: i
 ...
 */ function Bn(t) {
    return __awaiter(this, void 0, void 0, (function() {
        return __generator(this, (function(e) {
            if (t.code !== q$1.FAILED_PRECONDITION || "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab." !== t.message) throw t;
...
var zn = /** @class */ function() {
    ...
    t.prototype.Nr = function(t) {
        var e = this, n = new W$1(new B$1([])), r = new Qn(n, t), i = new Qn(n, t + 1), o = [];
        ...
        var e = new W$1(new B$1([])), n = new Qn(e, t), r = new Qn(e, t + 1), i = wt();
    ...
    return t.br = function(t, e) {
        return W$1.P(t.key, e.key) || U$1(t.Lr, e.Lr);
    }, 
    /** Compare by ID then by key */ t.Cr = function(t, e) {
        return U$1(t.Lr, e.Lr) || W$1.P(t.key, e.key);
    }, t;
}();
 ...
 */
function Wn(t, e) {
    if (0 !== e.length) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + cr(e.length, "argument") + ".");
}
 ...
 */ function Hn(t, e, n) {
    if (e.length !== n) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires " + cr(n, "argument") + ", but was called with " + cr(e.length, "argument") + ".");
}
 ...
 */ function Zn(t, e, n) {
    if (e.length < n) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + cr(n, "argument") + ", but was called with " + cr(e.length, "argument") + ".");
}
 ...
 */ function Yn(t, e, n, r) {
    if (e.length < n || e.length > r) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + cr(e.length, "argument") + ".");
}
...
function tr(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = ir(r);
        throw new x$1(q$1.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function er(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid value " + ir(r) + " provided to function " + t + "() for its " + hr(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
/** Helper to validate the type of a provided input. */ function nr(t, e, n, r) {
    if (!("object" === e ? rr(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = ir(r);
        throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function or(t, e, n) {
    if (void 0 === n) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + hr(e) + " argument, but it was undefined.");
}
 ...
 */ function sr(t, e, n) {
    O$1(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new x$1(q$1.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function ur(t, e, n, r) {
    var i = ir(r);
    return new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + hr(n) + " argument to be a " + e + ", but it was: " + i);
}

function ar(t, e, n) {
    if (n <= 0) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + hr(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function fr() {
    if ("undefined" == typeof Uint8Array) throw new x$1(q$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function lr() {
    if ("undefined" == typeof atob) throw new x$1(q$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var pr = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new x$1(q$1.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new x$1(q$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + cr(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Xn("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.qr = new Q$1(t);
}, yr = /** @class */ function(e) {
    /**
    ...
    return __extends(n, e), n.prototype.Qr = function(t) {
...
var br = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.Qr = function(t) {
        var e = new Ue(t.serializer, re(t.serializer, this.Hr));
    ...
    function t(t, e) {
        ...
        !isFinite(t) || t < -90 || t > 90) throw new x$1(q$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new x$1(q$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Yr = t, this.Xr = e;
    }
     ...
     */
    t.prototype.T = function(t) {
        return U$1(this.Yr, t.Yr) || U$1(this.Xr, t.Xr);
    }, t;
}();
...
/** Parse document data from a set() call. */ function Or(t, e, n, r, i, o) {
    ...
    if (o.merge) u = new Le(s.Me), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var c = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            ...
            if (!s.contains(d)) throw new x$1(q$1.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Wr(c, d) || c.push(d);
        }
...
/** Parse update data from an update() call. */ function Mr(t, e, n, r) {
    ...
    var u = new Le(o);
    return new kr(s.Ke(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Cr(t, e, n, r, i, o) {
    var s = t.uo(1 /* Update */ , e, n), u = [ Br(e, r, n) ], a = [ i ];
    if (o.length % 2 != 0) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    ...
    var g = new Le(c);
    return new kr(f.Ke(), g, s.fieldTransforms);
}
...
function jr(t, e) {
    ...
    e.path && e.path.length > 0 && e.Me.push(e.path) : O$1(t, (function(t, r) {
        var i = xr(r, e.io(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
 ...
 */ function zr(t, e, n) {
    try {
        return function(t) {
            if (t.search(vr) >= 0) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (yr.bind.apply(yr, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new x$1(q$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).qr;
    } catch (e) {
...
function Qr(t, e, n, r, i) {
    ...
    a += ")"), new x$1(q$1.INVALID_ARGUMENT, (u += ". ") + t + a);
}
...
var Zr = function(t, e) {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.Ro !== e ? (I$1("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
    ...
    t.prototype.qo = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new x$1(q$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.Wo(e);
            }));
        }));
    ...
    t.prototype.Uo = function(t) {
        ...
        return function(n) {
            e.ws.Bs((function() {
                return e.Co === t ? n() : (I$1("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return __extends(n, e), n.prototype.jo = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? q$1.UNKNOWN : st(t.code);
                ...
                y.document;
                var v = ce(t, y.document), g = y.readTime ? ue(y.readTime) : F$1.min(), m = new rn(v, g), w = y.removedTargetIds || [];
                n = new Dt([], w, m.key, m);
            ...
            if (!("targetChange" in t)) return F$1.min();
            var e = t.targetChange;
            return e.targetIds && e.targetIds.length ? F$1.min() : e.readTime ? ue(e.readTime) : F$1.min();
        }(t);
    ...
    return __extends(n, e), Object.defineProperty(n.prototype, "Jo", {
        /**
    ...
    return __extends(n, e), n.prototype.ih = function() {
        if (this.sh) throw new x$1(q$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.rh = function(t, e) {
        ...
        return this.ih(), this.credentials.getToken().then((function(r) {
            ...
            throw t.code === q$1.UNAUTHENTICATED && n.credentials.To(), t;
        }));
    }, 
    ...
    return t.prototype.fh = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.dh(), this.mutations.length > 0) throw new x$1(q$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof rn || t instanceof nn ? i.wh(t) : T$1();
                    })), r) ];
                }
            }));
        }));
        ...
        if (n) {
            ...
            throw new x$1(q$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.Th = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new x$1(q$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    t.prototype.set = function(t) {
        ...
        this.Ah ? (N$1(e), this.Ah = !1) : I$1("OnlineStateTracker", e);
            ...
            i.Bs((function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.$h() ? (I$1("RemoteStore", "Restarting streams for network reachability change."), 
    ...
    t.prototype.disableNetwork = function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.vh.length > 0 && (I$1("RemoteStore", "Stopping write stream with " + this.vh.length + " pending writes"), 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return I$1("RemoteStore", "RemoteStore shutting down."), this.Ch.add(5 /* Shutdown */), 
                    [ 4 /*yield*/ , this.zh() ];
    ...
    t.prototype.Zh = function(t) {
        ...
        this.Sh = new kt(this), this.xh.start(), this.kh.Rh();
    }, 
    /**
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 6:
                    ...
                    r.isEqual(F$1.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;
                  ...
                  case 11:
                    return I$1("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.na(o) ];
    ...
    t.prototype.ha = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return ot(r = t.code) && r !== q$1.ABORTED ? (e = this.vh.shift(), 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), this.kh.set("Unknown" /* Unknown */), this.Ch.delete(4 /* ConnectivityChange */), 
                    [ 4 /*yield*/ , this.Wh() ];
            ...
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    I$1("RemoteStore", "RemoteStore received new credentials"), this.Ch.add(3 /* CredentialChange */), 
                    [ 4 /*yield*/ , this.zh() ];
    ...
    return t.prototype.run = function() {
        ...
        try {
            ...
            return !H$1(e) && e.catch && e.then ? e : (this.Os.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    r, i, o) {
        ...
        this.ru = null, this.ou = new C$1((function(t) {
            return an(t);
        }), un), this.hu = new Map, 
        /**
    ...
    t.prototype.Eu = function(t, r, i) {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.su.pa(t, "rejected", r), e = this.cu.get(t), (i = e && e.key) ? (o = (o = new ut(W$1.P)).nt(i, new rn(i, F$1.min())), 
                    s = wt().add(i), u = new Tt(F$1.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new ct(U$1), o, s), [ 4 /*yield*/ , this.Ji(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.nu.$h() || I$1("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.vu = function(t) {
        this.fu.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new x$1(q$1.CANCELLED, t));
            }));
        })), this.fu.clear();
    }, t.prototype.Au = function(t, e) {
        var n = this._u[this.currentUser.lo()];
        n || (n = new ut(U$1)), n = n.nt(t, e), this._u[this.currentUser.lo()] = n;
    }, 
    /**
    ...
    t.prototype.yu = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof ai ? (this.lu.lr(i.key, t), this.Cu(i)) : i instanceof hi ? (I$1("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.uu.get(e) || (I$1("SyncEngine", "New document in limbo: " + e), this.au.push(e), 
        this.Vu());
    }, 
    /**
    ...
    t.prototype.Vu = function() {
        for (;this.au.length > 0 && this.uu.size < this.iu; ) {
            ...
            this.cu.set(e, new pi(t)), this.uu = this.uu.nt(t, e), this.nu.listen(new rt(sn.on(t.path).Pn(), e, 2 /* LimboResolution */ , Un.ds));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.Fu = function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : (I$1("SyncEngine", "User change. New user:", t.lo()), 
    ...
    function t(t) {
        this.ta = t, this.Nu = new C$1((function(t) {
            return an(t);
    ...
    return t.prototype.$i = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.Tn() || n.isEqual(F$1.min()) ? this.zu(t, e) : this.Ku.Yn(t, r).next((function(o) {
            var u = i.Hu(e, o);
            return (e.En() || e.mn()) && i.Ba(e.en, u, r, n) ? i.zu(t, e) : (E$1() <= LogLevel.DEBUG && I$1("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), hn(e)), 
    ...
    t.prototype.Ba = function(t, e, n, r) {
        ...
        return E$1() <= LogLevel.DEBUG && I$1("IndexFreeQueryEngine", "Using full collection scan to execute query:", hn(e)), 
        this.Ku.Zn(t, e, F$1.min());
    }, t;
}(), wi = /** @class */ function() {
    function t(t, e) {
        this.Wn = t, this.hr = e, 
    ...
    return t.prototype.Ju = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                W$1.W(i) || (i = i.child(""));
        var o = new Qn(new W$1(i), 0), s = new ct(U$1);
...
bi.ac = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.Ua = function(t) {
        var e = this, n = [];
...
var Ei = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             */
        this.Tc = new C$1((function(t) {
            return J$1(t);
        }), $), 
        /** The last received snapshot version. */
        this.lastRemoteSnapshotVersion = F$1.min(), 
    ...
    function t(t) {
        var e = this;
        this.gc = {}, this.vc = new Un(0), this.bc = !1, this.bc = !0, this.hr = t(this), 
    ...
    Commit: "commit"
}, Di = "gl-js/ fire/" + w$1, Pi = /** @class */ function() {
    function t(t) {
        this.s = t.s;
     ...
     */    return t.prototype.Jc = function(t, e) {
        ...
        return new Promise((function(o, s) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      case esm_2.NO_ERROR:
                        ...
                        I$1("Connection", "XHR received:", JSON.stringify(e)), o(e);
                        break;

                      case esm_2.TIMEOUT:
                        I$1("Connection", 'RPC "' + t + '" timed out'), s(new x$1(q$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case esm_2.HTTP_ERROR:
                        var n = u.getStatus();
                        if (I$1("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", u.getResponseText()), 
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new x$1(i, r.message));
                            } else s(new x$1(q$1.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        I$1("Connection", 'RPC "' + t + '" failed'), s(new x$1(q$1.UNAVAILABLE, "Connection failed."));
                        break;
            ...
            I$1("Connection", "XHR sending: ", i + " " + h);
        ...
        var n = [ this.Xc, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = esm_1(), o = {
        ...
        var p = n.join("");
        I$1("Connection", "Creating WebChannel: " + p + " " + o);
        var d = i.createWebChannel(p, o), y = !1, m = !1, E = new Ti({
            Qc: function(t) {
                m ? I$1("Connection", "Not sending because WebChannel is closed:", t) : (y || (I$1("Connection", "Opening WebChannel transport."), 
                d.open(), y = !0), I$1("Connection", "WebChannel sending:", t), d.send(t));
            },
            Wc: function() {
                return d.close();
            }
        ...
        return N(esm_4.EventType.OPEN, (function() {
            m || I$1("Connection", "WebChannel transport opened.");
        })), N(esm_4.EventType.CLOSE, (function() {
            m || (m = !0, I$1("Connection", "WebChannel transport closed"), E.Hc());
            ...
            }("Connection", "WebChannel transport errored:", t), E.Hc(new x$1(q$1.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!m) {
                ...
                if (i) {
                    ...
                    void 0 === s && (s = q$1.INTERNAL, u = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    m = !0, E.Hc(new x$1(s, u)), d.close();
                } else I$1("Connection", "WebChannel received:", n), E.Yc(n);
            }
        })), setTimeout((function() {
...
}(), ki = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Si = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        ...
        if (t.ml.El) throw new x$1(q$1.FAILED_PRECONDITION, ki);
        return new Ii(Ai.qc);
        ...
        throw new x$1(q$1.FAILED_PRECONDITION, ki);
    }, t;
}(), Li = /** @class */ function() {
    function t(t, 
    /**
     ...
     */
    e) {
        this.credentials = t, this.Ns = e, this.clientId = V$1.t()
        /**
    ...
    return t.prototype.start = function(t, e, n) {
        ...
        return this.credentials.Eo((function(t) {
            if (!s) return s = !0, I$1("FirestoreClient", "Initializing. user=", t.uid), r.Al(e, n, t, o).then(i.resolve, i.reject);
            r.Ns.si((function() {
                return r.nu.wa(t);
            }));
        })), 
    ...
    t.prototype.Pl = function(t) {
        return "FirebaseError" === t.name ? t.code === q$1.FAILED_PRECONDITION || t.code === q$1.UNIMPLEMENTED : !("undefined" != typeof DOMException && t instanceof DOMException) || 
    ...
    t.prototype.ih = function() {
        if (this.Ns.Xs) throw new x$1(q$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return this.ih(), r = new kn, [ 4 /*yield*/ , this.Ns.enqueue((function() {
                        return __awaiter(i, void 0, void 0, (function() {
                            var e, i, o;
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  ...
                                  case 1:
                                    return (e = n.sent()) instanceof nn ? r.resolve(e) : e instanceof rn ? r.resolve(null) : r.reject(new x$1(q$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                    [ 3 /*break*/ , 3 ];
...
var Mi = /** @class */ function() {
    ...
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new x$1(q$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        Kn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Fn.Ii; else {
            if (t.cacheSizeBytes !== Ci && t.cacheSizeBytes < Fn.mi) throw new x$1(q$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Fn.mi);
    ...
    function t(r, i, o) {
        ...
        this.Ll = new xn, this.INTERNAL = {
            ...
            var a = r;
            if (!a.projectId) throw new x$1(q$1.INVALID_ARGUMENT, "Must provide projectId");
            this.Jr = new L$1(a.projectId, a.database), 
    ...
    return Object.defineProperty(t.prototype, "Gl", {
        ...
        var e = new qi(t);
        if (this.ql && !this.jl.isEqual(e)) throw new x$1(q$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.jl = e, void 0 !== e.credentials && (this.Ql = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new x$1(q$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        ...
        var e, n;
        if (this.ql) throw new x$1(q$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new x$1(q$1.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return __awaiter(this, void 0, void 0, (function() {
            var t, r = this;
            return __generator(this, (function(i) {
                if (void 0 !== this.ql && !this.ql.Vl) throw new x$1(q$1.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new kn, [ 2 /*return*/ , (this.Ll.Js((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        var e, r;
                        return __generator(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), e = this.Xl(), [ 4 /*yield*/ , this.Wl.clearPersistence(e) ];
    ...
    }, Object.defineProperty(t.prototype, "Jl", {
        get: function() {
        ...
        return new S$1(this.Jr, this.Ul, this.jl.host, this.jl.ssl, this.jl.forceLongPolling);
    }, t.prototype.Hl = function(t, e) {
        var n = this.Xl();
        return this.ql = new Li(this.Ql, this.Ll), this.ql.start(n, t, e);
    }, t.Bl = function(t) {
        if (e = t.options, !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new x$1(q$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */        if (!n || "string" != typeof n) throw new x$1(q$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new L$1(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Ol) throw new x$1(q$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Ol;
        },
        enumerable: !1,
        configurable: !0
        ...
        this.Ml(), new $i(B$1.N(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return Hn("Firestore.doc", arguments, 1), Xn("Firestore.doc", "non-empty string", 1, t), 
        this.Ml(), Bi.Zl(B$1.N(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (Hn("Firestore.collectionGroup", arguments, 1), Xn("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.Ml(), new Yi(new sn(B$1.k(), t), this, 
        /* converter= */ null);
...
var Fi = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.i_) throw new x$1(q$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Bi = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return __extends(n, e), n.Zl = function(t, e, r) {
        if (t.length % 2 != 0) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.$() + " has " + t.length);
        ...
        !t) throw new x$1(q$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = B$1.N(t);
        ...
        function(t, e, n) {
            var r = new kn, i = zi(t, e, {
                ...
                next: function(t) {
                    ...
                    r.reject(new x$1(q$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : o && t.fromCache && n && "server" === n.source ? r.reject(new x$1(q$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : r.resolve(t);
                },
                error: function(t) {
                    return r.reject(t);
                }
...
/** The query class that is shared between the full, lite and legacy SDK. */ function Zi(t) {
    if (t.mn() && 0 === t.tn.length) throw new x$1(q$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var Yi = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.where = function(t, e, r) {
        ...
        void 0 === e || "asc" === e) r = "asc" /* ASCENDING */; else {
            if ("desc" !== e) throw new x$1(q$1.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + e + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
    ...
    /** Helper function to create a bound from a document or fields */ n.prototype.A_ = function(t, e, n, i) {
        if (or(t, 1, e), e instanceof Wi) return Hn(t, __spreadArrays([ e ], n), 1), this.E_(t, e.h_, i);
        var o = [ e ].concat(n);
        ...
        function(t, e, n) {
            var r = new kn, i = Xi(t, e, {
                ...
                next: function(t) {
                    // Remove query first before passing event to user to avoid
                    // user actions affecting the now stale query.
                    i(), t.fromCache && n && "server" === n.source ? r.reject(new x$1(q$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : r.resolve(t);
                },
                error: function(t) {
                    return r.reject(t);
                }
    ...
    return t.prototype.l_ = function(t, e, n) {
        var r;
        if (t.L()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + e + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === e) {
                this.__(n, e);
        ...
        if (null !== this.c_.startAt) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.c_.endAt) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var n = new In(t, e);
        return this.T_(n), n;
    }, 
    /**
    ...
    t.prototype.E_ = function(t, e, n) {
        if (!e) throw new x$1(q$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
        ...
        for (var r = [], i = 0, o = this.c_.orderBy; i < o.length; i++) {
            ...
            if (s.field.L()) r.push(Wt(this.Jr, e.key)); else {
                ...
                if (Rt(u)) throw new x$1(q$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === u) {
                    var a = s.field.$();
                    throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + a + "' (used as the orderBy) does not exist.");
                }
                r.push(u);
            }
        }
    ...
    t.prototype.m_ = function(t, e, n) {
        ...
        var r = this.c_.tn;
        if (e.length > r.length) throw new x$1(q$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.L()) {
                if ("string" != typeof s) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.c_.Vn() && -1 !== s.indexOf("/")) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.c_.path.child(B$1.N(s));
                if (!W$1.W(u)) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new W$1(u);
                i.push(Wt(this.Jr, a));
            } else {
    ...
    t.prototype.f_ = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.c_.Vn() && -1 !== t.indexOf("/")) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.c_.path.child(B$1.N(t));
            if (!W$1.W(e)) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return Wt(this.Jr, new W$1(e));
        }
        if (t instanceof Vr) return Wt(this.Jr, t.Zr);
        throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ir(t) + ".");
    }, 
    /**
    ...
    t.prototype.__ = function(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
        if (t.length > 10) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
        if (t.indexOf(null) >= 0) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
        ...
        if (t instanceof ln) {
            ...
            if (t.In()) {
                var o = this.c_.hn();
                if (null !== o && !o.isEqual(t.field)) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.c_.an();
                ...
                throw u === t.op ? new x$1(q$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new x$1(q$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
        ...
        if (!e.isEqual(t)) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}());
...
var Ji = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.P_.Bt) throw new x$1(q$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, sn.on(t), n, r) || this).g_ = t, t.length % 2 != 1) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.$() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new Bi(new W$1(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = V$1.t()), Xn("CollectionReference.doc", "non-empty string", 1, t);
        var e = B$1.N(t);
...
function Ki(t, e) {
    ...
    if (sr(t, e, [ "merge", "mergeFields" ]), Kn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + ir(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new x$1(q$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + ir(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof yr;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new x$1(q$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function no(t, e, n) {
    if (e instanceof Vr) {
        if (e.firestore !== n) throw new x$1(q$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
