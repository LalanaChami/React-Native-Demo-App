...
function newQueryComparator(query) {
    return function (d1, d2) {
        ...
        for (var _i = 0, _e = query.orderBy; _i < _e.length; _i++) {
            var orderBy = _e[_i];
...
function canonifyTarget(target) {
    var targetImpl = debugCast(target, TargetImpl);
...
var LocalStoreImpl = /** @class */ (function () {
    ...
    LocalStoreImpl.prototype.start = function () {
        return Promise.resolve();
    };
                ...
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        if (isIndexedDbTransactionError(e_2)) {
                            logDebug(LOG_TAG$3, 'Operation failed with retryable error: ' + e_2);
                        }
                        else {
...
var SyncEngineImpl = /** @class */ (function () {
    ...
    SyncEngineImpl.prototype.runTransaction = function (asyncQueue, updateFunction, deferred) {
                ...
                switch (_e.label) {
                    case 0:
                        if (!this.remoteStore.canUseNetwork()) {
                            logDebug(LOG_TAG$5, 'The network is disabled. The task returned by ' +
    ...
    SyncEngineImpl.prototype.updateTrackedLimbos = function (targetId, limboChanges) {
        for (var _i = 0, limboChanges_1 = limboChanges; _i < limboChanges_1.length; _i++) {
            ...
            if (limboChange instanceof AddedLimboDocument) {
                ...
                logDebug(LOG_TAG$5, 'Document no longer in limbo: ' + limboChange.key);
    ...
    SyncEngineImpl.prototype.trackLimboChange = function (limboChange) {
        ...
        if (!this.activeLimboTargetsByKey.get(key)) {
            logDebug(LOG_TAG$5, 'New document in limbo: ' + key);
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        logDebug(LOG_TAG$5, 'User change. New user:', user.toKey());
    ...
    SyncEngineImpl.prototype.enableNetwork = function () {
        return this.remoteStore.enableNetwork();
    };
    SyncEngineImpl.prototype.disableNetwork = function () {
...
var MemoryComponentProvider = /** @class */ (function () {
    ...
    MemoryComponentProvider.prototype.createRemoteStore = function (cfg) {
        var _this = this;
        return new RemoteStore(this.localStore, cfg.datastore, cfg.asyncQueue, function (onlineState) { return _this.syncEngine.applyOnlineStateChange(onlineState, 0 /* RemoteStore */); }, newConnectivityMonitor());
    };
...
var FirestoreClient = /** @class */ (function () {
     ...
     */
    FirestoreClient.prototype.start = function (databaseInfo, componentProvider, persistenceSettings) {
        var _this = this;
        this.verifyNotTerminated();
        this.databaseInfo = databaseInfo;
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _e.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, newConnection(this.databaseInfo)];
                    case 1:
                        connection = _e.sent();
                        serializer = newSerializer(this.databaseInfo.databaseId);
...
var DocumentReference = /** @class */ (function (_super) {
    ...
    DocumentReference.prototype.get = function (options) {
        ...
        if (options && options.source === 'cache') {
            ...
            return getDocViaSnapshotListener(this._firestoreClient, this._key, options).then(function (snapshot) { return _this._convertToDocSnapshot(snapshot); });
        }
    };
...
function addDocSnapshotListener(firestoreClient, key, options, observer) {
    ...
    var internalListener = firestoreClient.listen(Query.atPath(key.path), asyncObserver, options);
    return function () {
        asyncObserver.mute();
...
function getDocViaSnapshotListener(firestoreClient, key, options) {
    ...
    var unlisten = addDocSnapshotListener(firestoreClient, key, {
    ...
    BaseQuery.prototype.boundFromFields = function (methodName, values, before) {
        ...
        for (var i = 0; i < values.length; i++) {
            ...
            if (orderByComponent.field.isKeyField()) {
                ...
                var wrapped = parseQueryValue(this._dataReader, methodName, rawValue);
...
var Query$1 = /** @class */ (function (_super) {
    ...
    Query$1.prototype.get = function (options) {
        ...
        return (options && options.source === 'cache'
            ...
            : getDocsViaSnapshotListener(firestoreClient, this._query, options)).then(function (snap) { return new QuerySnapshot(_this.firestore, _this._query, snap, _this._converter); });
    };
    return Query$1;
}(BaseQuery));
/**
...
function getDocsViaSnapshotListener(firestore, query, options) {
    var result = new Deferred();
    var unlisten = addQuerySnapshotListener(firestore, query, {
        includeMetadataChanges: true,
        waitForSyncWhenOnline: true
    }, {
        next: function (snapshot) {
...
function addQuerySnapshotListener(firestore, query, options, observer) {
    ...
    var internalListener = firestore.listen(query, asyncObserver, options);
    return function () {
        asyncObserver.mute();
...
function changesFromSnapshot(snapshot, includeMetadataChanges, converter) {
    if (snapshot.oldDocs.isEmpty()) {
        ...
        return snapshot.docChanges.map(function (change) {
            ...
            debugAssert(!lastDoc_1 || newQueryComparator(snapshot.query)(lastDoc_1, change.doc) < 0, 'Got added events in wrong order');
